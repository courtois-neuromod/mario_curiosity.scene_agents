...
def parse_state_files(path_stats = "mario_curiosity.scene_agent"): # a remplacer avec la fonction de Yann
    """Load the states from the derivatives folder with additional info (sub, ses)."""

    base_folder = Path("/home/hugo/github/mario.scenes/data/mario/derivatives/scene_clips")
